...
The codes is built mainly with the algorithm of 66 from the numbers of **30 and 36** as been described above. The 30 is originated from 29 as 10th prime using _Jekyll/Liquid Pages_.

![frame](https://user-images.githubusercontent.com/36441664/67816683-560e3980-fadd-11e9-8a30-36901cbceaad.png)

All of their layout are managed with a _remote theme_ originated by the number of 66 which is converted to **6 + 6** out of the difference of Δ12 between the primes **23 and 11** using the algorithm of 36 as the perfect square from **6 by 6**.
