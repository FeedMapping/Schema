...
Consider if it is in fact generated by nature between the prime 23 and both primes (2,3) which are laid by two (2) times three (3) or **six (6) primes: (5, 7, 11, 13, 17,19)**. They flows uniformly within an hexagon chart called [The Prime Hexagon](https://www.hexspin.com/defining-the-prime-hexagon/) _(Credit: hexspin.com)_. 
