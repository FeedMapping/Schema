...
See that 23 has the number **two (2)** and **three (3)**, both are the two (2) only primes under their sum of prime five (5). Thus these primes symetri forms by their selves as a default. 
...
Now we are going to see why this could be happen. This flowchart is designed base on the behaviour of the primes number that flows uniformly within an hexagon chart called [The Prime Hexagon](https://www.hexspin.com/defining-the-prime-hexagon/) _(Credit: hexspin.com)_.
...
Let's discuss in more detail about the said primes which are laid by two (2) times three (3) or **six (6) primes: (5, 7, 11, 13, 17,19)**.
...
They will be managed within three (3) layers trough all the system.
