...
[![eQ19 Project](https://user-images.githubusercontent.com/36441664/88602920-fd84c080-d09d-11ea-970d-dd63c12221fc.png)](https://en.wikipedia.org/wiki/DNA#Genetic_recombination)
...
[![eQuantum Project](https://user-images.githubusercontent.com/36441664/162069734-fc8036a1-fd2d-4fc9-bcad-f677388b76fa.jpg)](base.html)
...
See that 23 has the number **two (2)** and **three (3)**, both are the two (2) only primes under their sum of prime five (5). Thus these primes symetri forms by their selves as a default condition. They will be managed within three (3) layers trough all the system.
...
```tip
Now let's calculate how many numbers are duplicates per screen:
* screen-1 has 6 numbers, multiplied by 6 to 36 there will be 6 - 1 or 5 duplicates
* screen-2 has 36 numbers, multiplied by 6 to 216 there will be 36 - 6 or 30 duplicates
* screen-3 has 72 numbers, multiplied 6x to 432 there will be 72 - 36 - 6 or 30 duplicates
```
...
Consider that if it is in fact generated by the nature between the prime 23 and both primes (2,3) as they even exist in a single unit of _[DNA](https://en.wikipedia.org/wiki/DNA)_.
