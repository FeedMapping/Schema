...
See that 23 has the number of **two (2)** and **three (3)**, both are the only two (2) primes under their sum of the prime five (5). These primes symetri forms by their selves as a default condition. Thus they will be managed within three (3) layers trough all the system.
