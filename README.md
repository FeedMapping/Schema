...
See that the 23 has number of **two (2)** and **three (3)** which are the only primes under the first prime 5. Therefore they will live trough all the system.
...
This symetri of three (3) sets of twin (2) primes forms a default condition.Consider that is generated by the nature between both primes (2,3). They exist even in a single unit of DNA.
