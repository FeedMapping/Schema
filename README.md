...
Now let's assume that all of the numbers above is a set of repositories group in GitHub. So here we can define a meaning by the algorrithm of _Trur Prime Pairs_ in words.
