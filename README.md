...
Consider if it is in fact generated by the nature between the prime 23 and both primes (2,3) laid by two (2) times three (3) or **six (6) primes: (5, 7, 11, 13, 17,19)** which are flows uniformly within an hexagon chart called [The Prime Hexagon](https://www.hexspin.com/defining-the-prime-hexagon/) _(Credit: hexspin.com)_.
...
Now we are going to see why this could be happen. Let's discuss in more detail about the said primes.
