...
See that the 23 has number of **two (2)** and **three (3)** which are the only primes under the first prime 5. This primes symetri forms a default condition. They will live trough all the system.
...
[![generate the primes (2,3)](https://user-images.githubusercontent.com/8466209/90985852-ca542500-e5a8-11ea-9027-9bfdcbe37966.jpg)](http://translate.google.com/translate?js=n&sl=id&tl=en&u=https://github.com/chetabahana/chetabahana.github.io/wiki#operasi)
 ...
 Consider that if it is in fact generated by the nature between the prime 23 and both primes (2,3) as they even exist in a single unit of DNA.
...
Now we are going to see why this could be happen. Let's discuss in more detail about that primes.
