...
[![₠Quantum Project](https://user-images.githubusercontent.com/36441664/162069734-fc8036a1-fd2d-4fc9-bcad-f677388b76fa.jpg)](https://eq19.github.io/base)
...
Consider if it is in fact generated by nature between the prime 23 and both primes (2,3) which are laid by two (2) times three (3) or **six (6) primes: (5, 7, 11, 13, 17,19)** that flow uniformly within an hexagon chart called [The Prime Hexagon](https://www.hexspin.com/defining-the-prime-hexagon/) _(Credit: hexspin.com)_.  
